...
Thank you for your interest in improving the **AWS Event-Driven & Messaging SRE Studio** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-event-sre.git
...
Generated configurations come from the **[AWS Event-Driven & Messaging SRE Studio Studio](https://pradeeptalari14.github.io/portfolio/tools/event-sre/)**.
